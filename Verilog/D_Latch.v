...
module D_Latch(
    ...
    and_B_to_A MakeChangedReadEdge0(ChangedReadEdge0, SupplyDigit, ReadEdge, PullDigit[1]);

    and_nB_to_A MakeChangedReadEdge1(ChangedReadEdge1, 2'b10, ChangedReadEdge0, PullDigit[0]);
